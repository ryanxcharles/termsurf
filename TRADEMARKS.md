...
- Referring to TermSurf by name in articles, reviews, documentation, and
  discussions (nominative fair use)
- Stating that your project is "based on TermSurf" or "a fork of TermSurf"
- Linking to the official TermSurf project
