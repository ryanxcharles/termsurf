...
The TermSurf project has strict rules for AI usage:
...
These rules apply only to outside contributions to TermSurf. Maintainers
...
Please remember that TermSurf is maintained by humans.
...
TermSurf is written with plenty of AI assistance, and many maintainers embrace
