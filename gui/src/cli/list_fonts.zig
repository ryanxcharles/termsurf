...
/// TermSurf. This uses the exact same font discovery mechanism TermSurf uses to
/// find fonts to use.
///
...
/// same priority order TermSurf would use to pick a font.
///
/// Flags:
///
...
///     is identical to the `font-family` set of TermSurf configuration values, so
