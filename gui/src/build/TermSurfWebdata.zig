//! TermSurfWebdata generates all the TermSurf website data that is
//! merged with the website for things like config references.
const TermSurfWebdata = @This();
...
pub fn init(
...

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_config_out,
            "share/termsurf/webdata/config.mdx",
        ).step);
    }

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_actions_out,
            "share/termsurf/webdata/actions.mdx",
        ).step);
    }

    {
        ...
        try steps.append(b.allocator, &b.addInstallFile(
            webgen_commands_out,
            "share/termsurf/webdata/commands.mdx",
        ).step);
    }
...
pub fn install(self: *const TermSurfWebdata) void {
