...
/// The set of key codes that TermSurf is aware of. These represent
...
/// UTF-8 and are produced by the associated apprt. TermSurf core has
/// no mechanism to map input events to strings without the apprt.
///
/// IMPORTANT: Any changes here update include/termsurf.h termsurf_input_key_e
pub const Key = enum(c_int) {
    ...
    /// Converts a W3C key code to a TermSurf key enum value.
    ///
    ...
    /// Converts a TermSurf key enum value to a W3C key code.
