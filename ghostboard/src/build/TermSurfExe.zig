...
/// The primary TermSurf executable.
exe: *std.Build.Step.Compile,

/// The install step for the executable.
install_step: *std.Build.Step.InstallArtifact,

pub fn init(b: *std.Build, cfg: *const Config, deps: *const SharedDeps) !TermSurf {
    ...
    switch (cfg.target.result.os.tag) {
        .windows => {
            ...
            exe.addWin32ResourceFile(.{
                .file = b.path("dist/windows/termsurf.rc"),
            });
        },
...
/// Add the termsurf exe to the install target.
