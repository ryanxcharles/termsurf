//! TermSurfFrameData generates a compressed file and zig module which contains (and exposes) the
//! TermSurf animation frames for use in `termsurf +boo`
const TermSurfFrameData = @This();
...
pub fn init(b: *std.Build) !TermSurfFrameData {
...
pub fn addImport(self: *const TermSurfFrameData, step: *std.Build.Step.Compile) void {
