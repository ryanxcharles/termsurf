% TERMSURF(1) Version @@VERSION@@ | TermSurf terminal emulator

# NAME

**termsurf** - TermSurf terminal emulator

# DESCRIPTION

TermSurf is a cross-platform, GPU-accelerated terminal emulator that aims to push
...
The unique goal of TermSurf is to have a platform for experimenting with modern,
...
While aiming for this ambitious goal, TermSurf is a fully standards compliant
