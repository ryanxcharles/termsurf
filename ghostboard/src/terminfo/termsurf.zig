...
/// TermSurf's terminfo entry.
pub const termsurf: Source = .{
    .names = &.{
        ...
        // features.
        // HACK: This is a hack on a hack...we use "xterm-termsurf" to prevent
    ...
    // verify that TermSurf does indeed support it and if not we can fix it.
    .capabilities = &.{
        ...
        // actually work with TermSurf. todo is to validate these!
