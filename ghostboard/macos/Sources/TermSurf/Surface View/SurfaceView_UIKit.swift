...
extension TermSurf {
    ...
    class SurfaceView: UIView, ObservableObject {
        ...
        var surfaceSize: termsurf_surface_size_s? {
            guard let surface = self.surface else { return nil }
            return termsurf_surface_size(surface)
        }

        private(set) var surface: termsurf_surface_t?
        ...
        func sizeDidChange(_ size: CGSize) {
            ...
            termsurf_surface_set_content_scale(surface, scale, scale)
            termsurf_surface_set_size(
                surface,
