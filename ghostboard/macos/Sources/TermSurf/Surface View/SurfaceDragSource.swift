            ...
            if operation == [] && !dragCancelledByEscape {
                ...
                if !endsInWindow {
                    NotificationCenter.default.post(
                        ...
                        object: surfaceView,
                        userInfo: [Foundation.Notification.Name.termsurfSurfaceDragEndedNoTargetPointKey: screenPoint]
                    )
                }
            }
...
extension Notification.Name {
    ...
    static let termsurfSurfaceDragEndedNoTarget = Notification.Name("termsurfSurfaceDragEndedNoTarget")
    
    /// Key for the screen point where the drag ended in the userInfo dictionary.
    static let termsurfSurfaceDragEndedNoTargetPointKey = "endedAtPoint"
}
