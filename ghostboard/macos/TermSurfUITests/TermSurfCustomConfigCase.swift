//
//  TermSurfCustomConfigCase.swift
//  TermSurf
//
...
class TermSurfCustomConfigCase: XCTestCase {
    ...
    func termsurfApplication() throws -> XCUIApplication {
        let app = XCUIApplication()
        app.launchArguments.append(contentsOf: ["-ApplePersistenceIgnoreState", "YES"])
        guard let configFile else {
            return app
        }
        app.launchEnvironment["TERMSURF_CONFIG_PATH"] = configFile.path
        return app
    }
}
