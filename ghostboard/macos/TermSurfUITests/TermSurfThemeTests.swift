...
final class TermSurfThemeTests: TermSurfCustomConfigCase {
    let windowTitle = "TermSurfThemeTests"
    ...
    func testQuickTerminalThemeChange() async throws {
        ...
        let title = "Debug builds of TermSurf are very slow and you may experience performance problems. Debug builds are only recommended during development."
