 ...
 * @file vt.h
 *
 * libtermsurf-vt - Virtual terminal emulator library
 * 
...
/**
 * @mainpage libtermsurf-vt - Virtual Terminal Emulator Library
 *
 * libtermsurf-vt is a C library which implements a modern terminal emulator,
 * extracted from the [TermSurf](https://termsurf.com) terminal emulator.
 *
 * libtermsurf-vt contains the logic for handling the core parts of a terminal
...
#ifndef TERMSURF_VT_H
#define TERMSURF_VT_H
...
#include <termsurf/vt/osc.h>
#include <termsurf/vt/sgr.h>
#include <termsurf/vt/key.h>
#include <termsurf/vt/paste.h>
#include <termsurf/vt/wasm.h>
