 ...
 * @file allocator.h
 *
 * Memory management interface for libtermsurf-vt.
 */

#ifndef TERMSURF_VT_ALLOCATOR_H
#define TERMSURF_VT_ALLOCATOR_H
 ...
 *
 * libtermsurf-vt does require memory allocation for various operations,
 ...
 *
 * libtermsurf-vt uses explicit memory allocation via an allocator
 * interface provided by TermSurfAllocator. The interface is based on the
 ...
 * function that accepts one,** and libtermsurf will use a default allocator.
 ...
 * 1. Implement the TermSurfAllocatorVtable function pointers
 * 2. Create a TermSurfAllocator struct with your vtable and context
 ...
 * Usage example:
 * @code
 * TermSurfAllocator allocator = {
 *     .vtable = &my_allocator_vtable,
 *     .ctx = my_allocator_state
 * };
 * @endcode
 */
typedef struct TermSurfAllocator {
    /**
     ...
     */
    const TermSurfAllocatorVtable *vtable;
} TermSurfAllocator;

/** @} */

#endif /* TERMSURF_VT_ALLOCATOR_H */
