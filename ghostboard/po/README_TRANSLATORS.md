# Localizing TermSurf: The Translators' Guide

First of all, thanks for helping us localize TermSurf!
...
file called `com.termsurf.pot`. **Do not edit this file.** The
template is generated automatically from TermSurf's code and resources, and are
...
```console
$ msginit -i po/com.termsurf.pot -l $LANG -o "po/$LANG.po"
```

> [!NOTE]
>
> TermSurf enforces the convention that all parts of the locale, including the
...
> encoding supported by TermSurf and its dependencies.**
>
...
Afterwards, you need to update the list of known locales within TermSurf's
...
```diff
 ...
 /po/com.termsurf.pot @ghostty-org/localization
...
- **Make TermSurf fit in with surrounding applications.**
  ...
  interface guidelines of each platform TermSurf is available for, including the
