...
use wezboard_escape_parser::csi::{Edit, EraseInDisplay, EraseInLine};
use wezboard_escape_parser::{OneBased, OperatingSystemCommand, CSI};
use wezboard_surface::{CursorShape, CursorVisibility, SequenceNo, SEQ_ZERO};
...
fn test_semantic_1539() {
    use wezboard_escape_parser::osc::FinalTermSemanticPrompt;
