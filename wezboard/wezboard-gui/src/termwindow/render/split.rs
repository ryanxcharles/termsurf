...
impl crate::TermWindow {
    pub fn paint_split(
        ...
        let hit_thickness = hit_thickness.max(1.0);
        ...
        if split.direction == SplitDirection::Horizontal {
            ...
            self.ui_items.push(UIItem {
                x: ((border.left.get() as f32 + padding_left + split.left as f32 * cell_width)
                    - (hit_thickness / 2.0))
                    .max(0.0) as usize,
                width: hit_thickness as usize,
            ...
            self.ui_items.push(UIItem {
                ...
                y: ((padding_top + first_row_offset + split.top as f32 * cell_height)
                    - (hit_thickness / 2.0))
                    .max(0.0) as usize,
                height: hit_thickness as usize,
                item_type: UIItemType::Split(split.clone()),
            });
        }
