...
use wezboard_blob_leases::{BlobLease, BlobManager, BoxedReader};
use wezboard_font::units::*;
use wezboard_font::{FontConfiguration, GlyphInfo, LoadedFont, LoadedFontId};
use wezboard_term::Underline;
...
impl GlyphCache {
    ...
    fn load_glyph(
        ...
        // can happen somehow; see <https://github.com/termsurf/termsurf/issues/1042>
        ...
        match &*handle.h {
            ...
            ImageDataType::AnimRgba8 {
                ...
                if frames.len() > 1 {
                    ...
                    // frame duration that wezboard can use when rendering.
                    ...
                    // <https://github.com/termsurf/termsurf/issues/3260>
