...
pub struct Pane {
    ...
    pub last_sent_resize_valid: bool,
    pub last_sent_pixel_width: u64,
    pub last_sent_pixel_height: u64,
    pub last_sent_screen_x: f64,
    pub last_sent_screen_y: f64,
    pub last_sent_screen_width: f64,
    pub last_sent_screen_height: f64,
    pub last_sent_screen_scale: f64,
    pub cursor_type: i64,
    pub visible: bool,
}
