...
This control character is implemented in TermSurf, although by default
most behaviors that TermSurf implements are disabled. See the documentation
...
terminator, TermSurf will terminate any responses with the
`BEL` character.
