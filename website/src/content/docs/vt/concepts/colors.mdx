...
initialized, hence their name. TermSurf supports three of these colors: the
foreground color, the background color and the cursor color, which are queried
or modified with [OSCs 10 to 12] respectively.
