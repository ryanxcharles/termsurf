...
TermSurf emulates a full 256-color palette, as well as 5 **special colors**
and 10 **dynamic colors**.
...
initialized, hence their name. TermSurf supports ten of these colors — the
foreground, background, and cursor colors, along with pointer, Tektronix, and
highlight colors — which are queried or modified with [OSCs 10 to 19]
respectively.

[OSCs 10 to 19]: /docs/vt/osc/1x
