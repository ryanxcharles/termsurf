...
- **Issue 209** (`docs/issues/0000209-web.md`) — Original `web` command design
  for ts2/ts3. Defined `web open`, `web close`, console output streaming. The
  TUI chrome concept did not exist; the browser was a full-pane overlay.
