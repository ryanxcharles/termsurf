...
A [CEF forum post](https://magpcss.org/ceforum/viewtopic.php?f=6&t=19628) reports
achieving 1100 FPS with `--disable-frame-rate-limit --disable-gpu-vsync`. Why
doesn't this work for us?
...
The forum poster noted: *"--disable-frame-rate-limit breaks latest stable CEF
render"* — confirming the flags stopped working in newer versions.
...
- Was added to Electron in [PR #42953](https://github.com/electron/electron/pull/42953)
