...
def assert_inventory_split() -> None:
    ...
    require("88 rows Oracle complete" in config_matrix, "CFG-223 oracle count not updated")
    require("91 rows closed" in config_matrix, "CFG-223 closed count not updated")
