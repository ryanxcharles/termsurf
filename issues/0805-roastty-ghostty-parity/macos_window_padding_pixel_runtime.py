...
def assert_inventory_split() -> None:
    ...
    require("custom-shader-animation" in runtime_inventory, "concrete renderer gap missing evidence")
    require("77 rows Oracle complete" in config_matrix, "CFG-223 oracle count not updated")
    require("80 rows closed" in config_matrix, "CFG-223 closed count not updated")
