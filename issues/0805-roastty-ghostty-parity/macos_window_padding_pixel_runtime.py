...
def assert_inventory_split() -> None:
    ...
    require("| RUNTIME-008B2B2B2B2B" in runtime_inventory, "missing remaining renderer gap row")
    require("GUI cursor pixels" in runtime_inventory, "remaining renderer gap omitted cursor pixels")
    require("broader GUI/pixel parity" in runtime_inventory, "remaining renderer gap omitted broader GUI parity")
    require("76 rows Oracle complete" in config_matrix, "CFG-223 oracle count not updated")
    require("79 rows closed" in config_matrix, "CFG-223 closed count not updated")
