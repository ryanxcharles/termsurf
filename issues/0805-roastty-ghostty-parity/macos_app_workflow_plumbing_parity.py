...
def main() -> int:
    ...
    require_all(
        ...
        [
            ...
            ("79 rows Oracle complete", "command palette CFG-223 oracle count"),
            ("82 rows closed", "command palette CFG-223 closed count"),
        ],
    )
    require_all(
        ...
        [
            ...
            ("79 rows Oracle complete", "terminal residual CFG-223 oracle count"),
            ("82 rows closed", "terminal residual CFG-223 closed count"),
        ],
    )
