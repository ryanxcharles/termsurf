...
This is a bounded source scanner for Issue 805 Experiment 13. It is not a Rust
parser; it reads the `Config::set_from_source` key-dispatch match and maps each
pinned Ghostty canonical option to the parser expression Roastty currently uses.
"""
