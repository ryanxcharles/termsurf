...
4. **Profile isolation and crash handling.** Experiment 29 proved profile
   storage separation. Prove Surfari crash/restart behavior next.
...
Experiment 29 proved Surfari profile isolation. The next experiment should move
to crash handling without mixing in the final Roamium comparison unless the
previous result specifically calls for it.
